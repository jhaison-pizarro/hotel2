...
@section('title_content_ol', 'Verificacion de salidas')
@section('content')
<style>
  .centrado {
    display: block;
    ...
    @foreach($habitaciones as $habitacion) 
      <div class="col-lg-3 col-xs-3 m-b-3">
       <div class="card">
           ...
           @if($habitacion->estado == '1')
          <br>
           <a href="{{ route('salidas_v', $habitacion->idhabitacion) }}" class="centrado btn_ocupado"  style="color:white; padding:3px; background-color: #dd4b39">VERIFICAR <i class="fa fa-long-arrow-right"></i></a>
           @endif
           @if($habitacion->estado == '2')
          <br>
